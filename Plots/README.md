...
|------|------------|------|-------------|
| dragon_pathfinding_hero.gif | 1280 x 720, 262 frames, 27.00 s | 14.52 MiB | Source-shaped steering, raster sprite, phase graph, fireball, and breath effects |
| dragon_trajectory_ensemble.gif | 1440 x 810, 128 frames, 18.36 s | 13.37 MiB | Viridis ensemble of 240 synchronized source-steered approaches with final hold |
| seed_loading.gif | 1280 x 720, 21 optimized frames, 11.94 s | 1.36 MiB | Outward chunk-status reveal in a 101 x 101 overview with 21 x 21 detail |
| structure_placement.gif | 1088 x 598, 96 frames, 11.52 s | 13.39 MiB | Complete wide-view Java 1.16.1 Overworld candidates |
| multi_structure_generation.gif | 1152 x 619, 96 frames, 12.52 s | 14.89 MiB | 3,169-chunk Nether view with all exact candidates and five-biome proxy |
| end_dimension_overview.png | 3245 x 2163 | 1.19 MiB | End fight geometry, first island ring, and overflow lattice |
| end_structure_generation.png | 3428 x 1698 | 1.88 MiB | Equal-panel End islands and four-sample modeled height audit |
| stronghold_rings.png | 2999 x 1838 | 1.62 MiB | Java 1.16.1 stronghold candidate rings |
...
- **Features**:
  ...
  - Smaller colour-treated raster dragon and polished landing-roll/crystal HUD
  - Source-shaped inertial steering plus sparse purple fireball and breath effects
...
- **Features**:
  ...
  - Viridis route density with stated square-root normalization
  - Stable hotspot cells whose map markers, bar lengths, and viridis colours share distinct-route counts
  - More than three seconds of final-state dwell after GIF optimization
...
- **Features**:
  - Approximately 912 x 912 chunk view with every in-bounds candidate
  ...
  - Fixed 192 x 192 chunk detail inset
...
- **Features**:
  ...
  - 101 x 101 terrain overview with a complete 21 x 21 detail inset
  - Explanatory status reveal propagates outward from the target chunk
  - Source-required terminal rings from `FULL` through `STRUCTURE_STARTS`
...
- **Features**:
  ...
  - 3,169 x 3,169 chunk view with all 29,772 candidates retained
  - Boundary-safe active-grid detail inset
...
- **Features**:
  ...
  - Exact End-city candidate grid and uniform 9 by 9 candidate window
  ...
  - Vertical height colourbar, 60-block contour, failures, and diagnostic inset
