...
| structure_placement.gif | 1080 x 607, 81 frames, 11.67 s | 7.96 MiB | Java 1.16.1 village candidate placement |
| multi_structure_generation.gif | 1080 x 607, 87 frames, 11.57 s | 7.15 MiB | Nether fortress, bastion, and portal candidates |
| end_dimension_overview.png | 3230 x 2163 | 1.22 MiB | Local End field and million-scale overflow structure |
| stronghold_rings.png | 2999 x 1833 | 1.06 MiB | Java 1.16.1 stronghold candidate rings |
| structure_analysis.png | 1754 x 2022 | 0.56 MiB | Compact four-panel Java 1.16.1 structure audit |
...
- **Type**: Step-by-step candidate placement visualization
- **Features**:
  - Exact 32 x 32 chunk regions
  - Exact region seed and Java LCG candidate rolls
  - 24 x 24 chunk candidate window
  - Visible eight-chunk excluded margins
  - Candidate trace with no fabricated biome gate
...
**Local End Geography and Distant Integer Overflow**
...
- **Features**:
  ...
  - Complete local outer-island projection through 18,000 blocks in each direction
  - Central island and 1,024-block outer-island gulf
...
**Java 1.16.1 Structure Analysis Dashboard**

![Structure Analysis](structure_analysis.png)

- **Type**: Four-panel static analysis
- **Features**:
  - Exact village candidate grid and expanded candidate window
  - Shared fortress and bastion candidates with an independent portal layer
  - Full 576-pair village-offset distribution
  - Exact 40/60 fortress and bastion type split
  - Tight 2 x 2 comparison layout with coordinated Nether colors
  - Explicit separation of exact overlays from illustrative terrain
- **Generated By**: Code/minecraftStructureAnalysis.py
