...
|------|------------|------|-------------|
| dragon_pathfinding_hero.gif | 1280 x 720, 263 frames, 27.00 s | 13.96 MiB | Source-audited phase graph, all 11 highlighted phases, and representative legal routes |
| dragon_trajectory_ensemble.gif | 1232 x 662, 128 frames, 18.36 s | 8.38 MiB | Viridis ensemble of 240 synchronized seeded approaches with final hold |
| seed_loading.gif | 1280 x 720, 80 frames, 11.60 s | 4.14 MiB | Source-required chunk-status rings with 7 x 7 detail |
| structure_placement.gif | 1088 x 598, 96 frames, 11.52 s | 13.39 MiB | Complete wide-view Java 1.16.1 Overworld candidates |
| multi_structure_generation.gif | 1152 x 619, 104 frames, 13.48 s | 12.01 MiB | Wide-view Nether fortress, bastion, and portal candidates |
| end_dimension_overview.png | 3245 x 2163 | 1.19 MiB | End fight geometry, first island ring, and overflow lattice |
| end_structure_generation.png | 3477 x 1698 | 0.79 MiB | Equal-panel End islands and viridis city qualification prior |
...
- **Features**:
  ...
  - Smaller wing-emphasized dragon sprite and polished landing-roll/crystal HUD
...
- **Features**:
  ...
  - 31 x 31 overview with a readable central 7 x 7 detail inset
...
- **Features**:
  ...
  - Approximately 685 x 685 chunk view with every candidate retained
  - Boundary-safe active-grid detail inset
  - Crimson, indigo, basalt, soul-sand, and lava-gold terrain palette
  - Source-informed terrain context that does not suppress candidates
...
- **Features**:
  ...
  - Nearest-cell viridis heatmap of the fixed-seed `1/81` prior
  - Documented 2D island-support mask and vertical probability colourbar
