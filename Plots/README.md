...
| dragon_trajectory_ensemble.gif | 960 x 640, 8 FPS | generated | 420 seeded approach trajectories |
| redstone_quasi_connectivity.gif | 960 x 600, 10 FPS | generated | Quasi-connectivity BUD cycle |
| seed_loading.gif | 2160 x 1200, 20 FPS | 6.5 MB | Seed and chunk-layer loading trace |
| structure_placement.gif | 2880 x 1600, 15 FPS | 5.9 MB | Java 1.16.1 village candidate placement |
| stronghold_rings.png | 3791 x 2135, 300 DPI | 0.9 MB | Java 1.16.1 stronghold candidate rings |
| structure_analysis.png | 3237 x 2420, 220 DPI | 0.8 MB | Six-panel Java 1.16.1 structure analysis |
...
### redstone_quasi_connectivity.png and .gif
**Java 1.16.1 Quasi-Connectivity**

![Quasi-Connectivity Diagram](redstone_quasi_connectivity.png)

- **Type**: Isometric mechanism diagram and BUD animation
- **Features**:
  - Elevated quasi-power source
  - Separate neighbor-update pulse
  - Pending extension and retraction states
  - Minecraft-style piston, note block, and lever geometry
- **Generated By**: Code/redstone_quasi_connectivity.py
...
- **Features**:
  - Outward spiral through 32 x 32 chunk regions
  - Exact region seed and Java LCG candidate rolls
  - 24 x 24 chunk candidate window
  - Separate biome-pass and biome-reject states
  - Run statistics with no fake spawn-probability shortcut
...
- **Features**:
  ...
  - Ring table and origin-centered coordinate frame
...
- **Type**: Six-panel static analysis
- **Features**:
  - Exact village candidate grid and biome-layer preview
  - Candidate-distance distribution
  - Complete eight-ring stronghold geometry
