...
| seed_loading.gif | Progressive terrain-stage view with a vanilla-style 21 by 21 status tracker |
...
- **Features**:
  ...
  - Terrain begins empty and gains biome, noise, surface, feature, lighting, and completion layers
  - Vanilla-style spawn-region status grid using the source loading-screen colours
