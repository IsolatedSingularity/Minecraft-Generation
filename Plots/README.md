...
- **Features**:
  ...
  - Broad terrain overview with a complete 21 x 21 detail inset
  - Explanatory radial request front propagates outward from the target chunk
...
- **Features**:
  ...
  - Tightly framed main view with every in-bounds candidate retained
  - Wider boundary-safe active-grid detail inset
