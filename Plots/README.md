...
|------|------------|------|-------------|
| dragon_pathfinding_hero.gif | 1280 x 720, 270 frames, 27.00 s | 13.58 MiB | End arena, complete phase taxonomy, and representative legal routes |
| dragon_trajectory_ensemble.gif | 1232 x 662, 144 frames, 17.28 s | 9.20 MiB | Ensemble of 240 seeded legal-route approaches |
...
| end_structure_generation.png | 2961 x 1818 | 0.89 MiB | Dense End islands and fixed-seed End-city qualification prior |
...
- **Features**:
  ...
  - All 11 Java 1.16.1 dragon phase types, with exceptional phases visually subdued
  - Source-shaped island terrain, exact spike footprints, and End fountain
  - Compact crystal display and explicitly contextualized next-path landing roll
...
- **Features**:
  ...
  - Stable final hotspot cells whose bar lengths and colours accumulate honestly
...
- **Features**:
  - Dense projected outer-island footprints
  - Exact End-city candidate grid and uniform 9 by 9 candidate window
  - Fixed-seed `1/81` prior masked by the documented 2D island-support gate
  - Simplified symbolic End-ship glyphs for qualified city starts
